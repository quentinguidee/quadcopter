...
void Send::failedToSetup() { message("D6"); }
void Send::setupDone() { message("D7"); }

void Send::motorSetup(uint8_t id)
{
    message("M" + String(id + 1) + "2");
}
...
void Send::motorFailedToSetup(uint8_t id)
{
    message("M" + String(id + 1) + "3");
}
